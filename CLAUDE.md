...
- **Theme**: Dark with poker aesthetic (deep navy/charcoal backgrounds)
- **Primary color**: Amber/gold (`--primary: #f59e0b`)
- **Typography**: Clean, modern. Lato for Latin, Rubik for Hebrew
- **Animations**: Subtle fade-in-up on scroll (Framer Motion)
